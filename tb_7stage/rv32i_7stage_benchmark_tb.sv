...
// 7-stage benchmark testbench. Loads benchmark hex via $readmemh,
// runs until halt (jal x0,0), then reads performance counters.
// The hex file name is set by +define+BENCH_HEX="filename.hex" or
// defaults to bench_diagnostic.hex.

module rv32i_7stage_benchmark_tb;
  ...
  initial begin
    $display("");
    $display("==========================================================");
    $display("  7-Stage Pipeline Benchmark Suite");
    $display("==========================================================");
    $display("");
    ...
    $display("==========================================================");
    $display("  7-Stage Benchmark Suite Complete");
    $display("==========================================================");
    $finish;
  end
