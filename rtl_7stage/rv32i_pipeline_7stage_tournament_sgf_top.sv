...
module rv32i_pipeline_7stage_tournament_sgf_top (
  input logic clk,
  input logic rst_n,
  ...
  output logic [31:0] debug_alu_result
    ...
    // must be suppressed. Otherwise the flush resets pipe_if1_if2 to pc=0,
    // corrupting the predictor's GHR/RAS state via spurious predictions on pc=0.
    ...
    branch_predictor_tournament_sgf u_bp (
        .clk            (clk),
        .rst_n          (rst_n),
        .pc_if          (if2_pc),
