# sim_7stage.tcl — Simulate 7-stage pipeline in Vivado
# Usage: Open Vivado TCL console, cd to project root, then:
#   source sim_7stage.tcl
...
set work_dir "C:/Users/Joshi/RISCV-sim/7stage"
file mkdir $work_dir
create_project sim_7stage $work_dir -part xc7a35tcpg236-1 -force
...
# Set top modules
set_property top rv32i_pipeline_7stage_top [current_fileset]
set_property top rv32i_7stage_tb [get_filesets sim_1]

# Copy hex program for $readmemh
set sim_dir "$work_dir/sim_7stage.sim/sim_1/behav/xsim"
file mkdir $sim_dir
...
puts ""
puts "=== 7-Stage Pipeline Project Created ==="
puts "Sim top:  rv32i_7stage_tb"
