...
module rv32i_pipeline_7stage_tage_sgf_top (
  input logic clk,
  input logic rst_n,
  ...
  output logic [31:0] debug_alu_result
    ...
    logic [15:0] if2_ghr_checkpoint;
    logic [15:0] id_ghr_checkpoint;
    logic [15:0] ex1_ghr_checkpoint;
    logic [15:0] ex2_ghr_checkpoint;
    ...
    branch_predictor_tage_sgf u_bp (
        .clk            (clk),
        .rst_n          (rst_n),
        .pc_if          (if2_pc),
        ...
        .flush_ghr      (16'b0),  // committed_ghr restored internally by SGF predictor
