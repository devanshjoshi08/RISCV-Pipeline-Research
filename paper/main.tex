...
SGF adapts the dual-GHR checkpointing concept---established in ASIC out-of-order processors---to the resource and routing constraints of in-order soft cores on LUT-based FPGA, where reorder buffers and deep checkpoint arrays are impractical.
