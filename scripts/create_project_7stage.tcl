...
create_project $project_name "$project_dir/vivado_7stage" -part xc7a35tcpg236-1 -force
...
set sim_dir "$project_dir/vivado_7stage/$project_name.sim/sim_1/behav/xsim"
file mkdir $sim_dir
...
puts ""
puts "Project created: vivado_7stage/$project_name.xpr"
puts "Sim top:     rv32i_7stage_tb"
puts "Synth top:   rv32i_pipeline_7stage_top"
